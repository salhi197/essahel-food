                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card mt-2">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="{{route('commande.create')}}" enctype="multipart/form-data" id="Commandeform">
                                        @csrf
                                        ...
                                        <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control fournisseurs js-example-basic-single" size="5" name="fournisseur" id="">
                                            ...
                                            <div class="form-group items" id="dynamic_form">
                                                ...
                                                <div class="button-group" style="padding: 27px;">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class='form-control produits js-example-basic-single' name='produit' id="produit" >
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control " placeholder="Date" value="" name="date_livraison" type="date"/>
                                                        </div>
                                                    </div>
 ...
 -->
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="echange_nouveau" id="">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block" type="submit">Insérer Commande</button></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
