...
<div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card mt-2">
                                    ...
                                    <div class="card-body">
                                        <form method="post" action="{{route('commande.update',['commande'=>$commande->id])}}" enctype="multipart/form-data" id="Commandeform">
                                        @csrf
                                            ...
                                            <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <?php 
                                                            $f = json_decode($commande->fournisseur);

                                                            ?>
                                                            @foreach($fournisseurs as $fournisseur)
                                                                    <option value="{{$fournisseur}}" 
                                                                    <?php if($fournisseur->id == $f->id){?> selected <?php } ?>
                                                                     >
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class='form-control produits' name='dynamic_form[dynamic_form][{{$key}}][produit]' id="produit" >
                                                            <option value="">Séléctionner un produit</option>
                                                            @foreach($produits as $produit)
                                                            <option class="product fournisseur_{{$produit->fournisseur_id ?? ''}}" 
                                                                <?php if($product->id == $produit->id){?> selected <?php } ?>
                                                             value="{{$produit}}">
                                                        ...
                                                        <input type="hidden" class="form-control " value="{{json_encode($product) ?? ''}}" name="dynamic_form[dynamic_form][{{$key}}][produit]">
                                                    <div class="col-md-3">
                                                        <label class="small mb-1" for="inputEmailAddress">Quantité : </label>
                                                        <input type="number" class="form-control quantites" value="{{$product->quantite ?? ''}}" name="dynamic_form[dynamic_form][{{$key}}][quantite]" id="quantite" placeholder="Entere Quantité Produit ";>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <label class="small mb-1" for="inputEmailAddress">Prix : </label>
                                                        <input type="number" class="form-control prixs" name="dynamic_form[dynamic_form][{{$key}}][prix]" value="{{$product->prix_vente ?? ''}}" id="prix" placeholder="Entere Quantité Produit ";>
                                                    </div>
                                                </div>
                                            @endforeach
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input  class="form-control py-4" value="{{$commande->nom_client}}" name="nom_client" id="nom" type="text" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input  class="form-control py-4" id="telephpone" value="{{$commande->telephone ?? ''}}" value="{{$commande->telephone}}" name="telephone" type="text" placeholder="" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input  class="form-control py-4" value="{{$commande->adress}}" name="adress" id="adress" type="text" placeholder="entrer l'adress complete  : " />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input  class="form-control py-4" value="{{$commande->code_tracking}}" name="code_tracking" 
                                                        value="{{$commande->code_tracking}}"
                                                        readonly="true"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="wilaya_select"  name="wilaya_id">
                                                                ...
                                                                @foreach ($wilayas as $wilaya)
                                                                    <option value="{{$wilaya->id}}" {{$wilaya->id == $commande->wilaya  ? 'selected' : ''}}>
                                                                        {{$wilaya->name}}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control " placeholder="Commune ..." value="{{$commande->commune}}" name="commune" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">{{ __('Date de livraison') }}: </label>
                                                            <input class="form-control " placeholder="Date" value="{{$commande->date_livraison}}"  name="date_livraison" type="date"/>
                                                        </div>
                                                    </div>
 ...
 -->
                                            ...
                                            <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block" type="submit">Enregistrer Commande</button></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
