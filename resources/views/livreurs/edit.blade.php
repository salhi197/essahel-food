                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card mt-2">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post" action="{{route('livreur.update')}}">
                                        @csrf
                                            <input type="hidden" name="livreur_id" value="{{$livreur->id ?? ''}}" class="form-control"/>

                                            <div class="form-row">
                                            <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName">nom et prenom: </label>
                                                        <input type="text" name="nom" value="{{$livreur->name ?? ''}} {{$livreur->prenom ?? ''}}" class="form-control"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName">Mot de passe : </label>
                                                        <input type="text" name="password" value="{{$livreur->password_text ?? ''}}" class="form-control"/>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input  class="form-control py-4" value="{{$livreur->email ?? '' }}" name="email" id="email" type="text" placeholder="" />
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="wilaya_select" name="wilaya_id">
                                                                ...
                                                                @foreach ($wilayas as $wilaya)
                                                                    ...
                                                                    <option value="{{$wilaya->id}}" {{$livreur->wilaya_id == $wilaya->id  ? 'selected' : ''}}>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="commune_id" id="commune_select">
                                                                ...
                                                                @foreach ($communes as $commune)
                                                                    ...
                                                                    <option value="{{$commune->id}}" {{$livreur->commune_id == $commune->id  ? 'selected' : ''}}>
