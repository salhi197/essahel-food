                                            ...
                                            ">
                                                ...
                                                <td >
                                                    ...
                                                    <div class="dropdown">
                                                                ...
                                                                <a 
                                                                onclick="return confirm('etes vous sure ?')"
                                                                href="/commande/affecter/action/{{$commande->id}}/{{$_livreur}}" class="btn btn-warning">Affecter </a>
                                                    </div>                                                
                                                </td>
...
<script>
        ...
        $(document).ready(function () {
            ...
            //     var hrefAttacher = "/commande/affecter/list?id=";
            //     var pritnA4 = "/commande/print/a4?id=";
            //     var printTicket = "/commande/print/ticket?id=";
            //     for(var i=0; i<checks.length; i++){
            //         hrefAttacher =hrefAttacher +$(checks[i]).val()+",";
