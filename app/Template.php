    ...
    public static function templateBon($commande,$margin) {
        ...
        $html='
            ...
            <div style="position:absolute;left:0px;top:'.(int)($margin+0).'px">
                <img src="'.asset("img/background2.jpg").'" width=595 height=841></div>
                <div style="position:absolute;left:144.73px;top:'.(int)($margin+22.56).'px" class="cls_002"><span class="cls_002">Date</span></div>
                <div style="position:absolute;left:172.57px;top:'.(int)($margin+22.56).'px" class="cls_002"><span class="cls_002"></span></div>
                <div style="position:absolute;left:306.49px;top:'.(int)($margin+23.04).'px" class="cls_002"><span class="cls_002">Numéro Téléphone</span></div>
                <div style="position:absolute;left:306.49px;top:'.(int)($margin+40.04).'px" class="cls_002"><span class="cls_002">Fournisseur : </span></div>
                <div style="position:absolute;left:404.89px;top:'.(int)($margin+22.52).'px" class="cls_007"><span class="cls_007"></span></div>
                <div style="position:absolute;left:404.89px;top:'.(int)($margin+40.52).'px" class="cls_007"><span class="cls_007"></span></div>
                <div style="position:absolute;left:144.25px;top:'.(int)($margin+40.32).'px" class="cls_002"><span class="cls_002"> </span></div>
                <div style="position:absolute;left:510.97px;top:'.(int)($margin+15.24).'px" class="cls_006"><span class="cls_006"></span></div>
                <div style="position:absolute;left:20.89px;top:'.(int)($margin+33.36).'px" class="cls_002"><span class="cls_002"><img src="" width=80 height=30></span></div>
                <div style="position:absolute;left:20.89px;top:'.(int)($margin+22.36).'px" class="cls_002"><span class="cls_002"></span></div>
                ';


            $html = $html.'<div style="position:absolute;left:500.33px;top:'.(int)($margin+22.56).'px" class="cls_003"><span class="cls_003" > </span></div>


                <div style="position:absolute;left:526.33px;top:'.(int)($margin+55.56).'px" class="cls_005"><span class="cls_005" style="font-size:25px;"></span></div>
                <div style="position:absolute;left:510.33px;top:'.(int)($margin+88.56).'px" class="cls_005"><span class="cls_005" style="font-size:10px;"></span></div>
            ...
            ';
                ...
                <div style="position:absolute;left:370.45px;top:'.(int)($margin+104.16).'px" class="cls_008"><span class="cls_008"></span></div>
                <div style="position:absolute;left:395.45px;top:'.(int)($margin+124.16).'px" class="cls_008"><span class="cls_008"></span></div>
                <div style="position:absolute;left:519.13px;top:'.(int)($margin+112.80).'px" class="cls_008"><span class="cls_008">ReportÈ Le</span></div>
                <div style="position:absolute;left:349.69px;top:'.(int)($margin+149.28).'px" class="cls_008"><span class="cls_008">++++++++++++++++++++++++</span></div>
                <div style="position:absolute;left:529.21px;top:'.(int)($margin+149.28).'px" class="cls_008"><span class="cls_008">N.R.P</span></div>
                <div style="position:absolute;left:351.13px;top:'.(int)($margin+166.56).'px" class="cls_004"><span class="cls_004">Note  : </span></div>
                <div style="position:absolute;left:268.09px;top:'.(int)($margin+167.48).'px" class="cls_010"><span class="cls_010">Da</span></div>
                <div style="position:absolute;left:254.65px;top:'.(int)($margin+189.12).'px" class="cls_008"><span class="cls_008">SociÈtÈ de livraison Ls-Rapide</span></div>
            </div>
