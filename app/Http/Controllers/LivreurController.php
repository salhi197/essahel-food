...
class LivreurController extends Controller
{
    ...
    {
        $tickets = DB::select("select t.created_at as created_at,t.updated_at as updated_at,t.id,t.id_produit,t.codebar,t.satut from tickets t, sorties s where t.id = s.id_ticket and s.id_livreur='$id_livreur' ");
        $livreur=Livreur::find($id_livreur);
        $date_debut = date('Y-m-d');
        $date_fin = date('Y-m-d');
        $tickets = DB::select("select t.created_at as created_at,t.updated_at as updated_at,t.id,t.id_produit,t.codebar,t.satut from tickets t, sorties s where t.id = s.id_ticket and DATE(t.updated_at) between '$date_debut' and '$date_fin' and s.id_livreur='$id_livreur' ");
